...
<body>
    ...
    <!-- Quick view -->
    @include('frontend.components.common.quick_view')
    <!-- Header  -->
        ...
        function productView(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // brand name
                    if (data.product.brand.brand_name) {
        ...
        function compare() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#totalCompare').text(response.compareQty);
                    var rows = ""
               ...
               <div class="detail-extralink mr-15">
                   <div class="detail-qty border radius">
                    <a type="submit" class="qty-down" id="${value.rowId}" onclick="cartDecrement(this.id)"><i class="fi-rs-angle-small-down"></i></a>
                         ...
                         <a  type="submit" class="qty-up" disabled id="${value.rowId}" onclick="cartIncrement(this.id)"><i class="fi-rs-angle-small-up"></i></a>
                   </div>
               </div>
           </td>
           <td class="price" data-title="Price">
