        ...
        <div class="tab-content" id="myTabContent">
            ...
            @foreach ($category as $item)
                <div class="tab-pane fade" id="category{{ $item->id }}" role="tabpanel">
                    <div class="row product-grid-4">
                        @php
                        $category_product= App\Models\Product::where('category_id',$item->id)->latest()->get();
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{url('/produt/details/'.$c_t_product->id.'/'.$c_t_product->product_slug)}}">
                                            <img class="default-img" src="{{ asset($c_t_product->product_thambnail) }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset($c_t_product->product_thambnail) }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a href="shop-grid-right.html">{{ $c_t_product->category->category_name }}</a>
                                    </div>
                                    <h2><a href="{{url('/produt/details/'.$c_t_product->id.'/'.$c_t_product->product_slug)}}">{{ $c_t_product->product_name }}</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                                        </div>
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        @else
                                            <div class="product-price">
                                                <span>${{ $c_t_product->selling_price }}</span>
                                                <span class="old-price">${{ $c_t_product->discount_price }}</span>
                                            </div>
                                        @endif
