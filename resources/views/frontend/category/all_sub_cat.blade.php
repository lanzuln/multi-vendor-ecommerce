        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <h1 class="mb-15">{{ $Sub_categories_name->name }}</h1>
                        <div class="breadcrumb">
                            <a href="index.html" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                            <span></span>{{ $Sub_categories_name->category->category_name }} <span></span>{{ $Sub_categories_name->name }}
                        </div>
                    </div>
            ...
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        @php
                        $total_sub_category = App\Models\Product::where('Subcategory_id', $Sub_categories_name->id)->get();
                    @endphp
                        <p>We found <strong class="text-brand">{{ count($total_sub_category) }}</strong> items for you!</p>
                    </div>
