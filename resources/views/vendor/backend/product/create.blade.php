...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <hr />
          <form action="{{route('vendor.store.product')}}" method="post" enctype="multipart/form-data" id="myForm">
            @csrf
                    ...
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea id="summernote" name="long_descp"></textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input oninput="newImg.src=window.URL.createObjectURL(this.files[0])"
                                    class="form-control" name="product_thambnail" type="file" id="photo">
                            </div>
                            ...
                            <div class="form-group mb-3" id="preview_img">
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#category_id').on('change', function() {
            ...
            if (category_id) {
                $.ajax({
                    url: "{{ url('/subcategory/vendor/ajax') }}/" + category_id,
                    type: "GET",
                    dataType: "json",
