            ...
            <div class="card-body">
                <div class="form-group mb-3">
                    ...
                    <input oninput="newImg.src=window.URL.createObjectURL(this.files[0])" class="form-control"
                        name="product_thambnail" type="file" id="photo">
                </div>

                <div class="form-group mb-3">
                    <img class="" src="{{ asset($products->product_thambnail) }}" id="newImg"
                        width="150">
                </div>


                <input type="submit" class="btn btn-primary px-4" value="Update Thumbnail" />
                    ...
                    <form method="post" action="{{ route('vendor.update.product.multiimage') }}"
                        ...
                        @foreach ($multiImgs as $key => $img)
                            <tr>
                                ...
                                <td> <img src="{{ asset($img->photo_name) }}" style="width:70; height: auto;"> </td>
                                <td><input
