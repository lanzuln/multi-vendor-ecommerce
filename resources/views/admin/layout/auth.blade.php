...
<head>
	...
	<link href="{{ asset('backendAdmin/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" />
				...
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="col mx-auto">
						<div class="mb-4 text-center">
							<img src="{{ asset('backendAdmin/assets/images/logo-img.png')}}" width="180" alt="" />
						</div>
						<div class="card">
							<div class="card-body">
                          ...
                          <img class="me-2" src="{{ asset('backendAdmin/assets/images/icons/search.svg')}}" width="16" alt="Image Description">
