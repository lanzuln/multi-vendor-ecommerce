                        ...
                        <div class="login_wrap widget-taber-content background-white">
                            <div class="padding_eight_all bg-white">
                                <div class="heading_s1">
                                    <h1 class="mb-5">Bocome Vendor</h1>
                                    <p class="mb-30">Already have a vendor account? <a href="{{route('vendor.login')}}">Login</a></p>
                                </div>

                                    <form method="POST" action="{{ route('vendorRegister') }}" class="vendor_registration">
                                        @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="join_at" placeholder="enter join date" value="{{old('join_at')}}"/>
                                        @error("join_at")
                                        <code style="color-red">{{$message}}</code>
                                    @enderror
                                    </div>
