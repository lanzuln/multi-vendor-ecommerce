                                ...
                                <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <br>
                                            <div>
                                                <img src="{{ asset($user->photo ?? 'default.jpg') }}" alt="Admin"
                                                    class="image_fit" width="220" height="150">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" action="{{ route('profile.update') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <img src="{{ asset($user->photo ?? 'default.jpg') }}"
                                                            id="newImg" alt="Admin" class="image_fit"
