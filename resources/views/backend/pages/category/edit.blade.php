    ...
    <div class="card">
        <div class="card-body">
            <form method="post"  action="{{route('update.category')}}" enctype="multipart/form-data">
                ...
                <input type="text" hidden name="old_image" value="{{$category->category_image}}">
                <div class="row mb-3">
                    <div class="col-sm-2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 text-secondary">
                        <input type="file"
                            ...
                            class="form-control" name="category_image" value="">
                    </div>
                </div>
                {{-- preview --}}
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 text-secondary">
                        <img src="{{ !empty($category->category_image) ? asset($category->category_image) : asset('default.jpg') }}" id="newImg"
