...
class homecontroller extends Controller
{
    ...
    public function CatWiseProduct(Request $request,$id){
     ...
     public function ProductSearch(Request $request){
        ...
        return view('frontend.layout.product.search',compact('products','item','categories','newProduct'));
    ...
    public function SearchProduct(Request $request){
        ...
        $request->validate(['search' => "required"]);
         ...
         return view('frontend.layout.product.search_product',compact('products'));
